...
public class ServiceGuestTable extends AbstractTableModel{
	Connection con;
	...
	public void getList(){
		...
		sql.append(" guest g where s.service_id=su.service_id");
		sql.append(" and su.hotel_user_id=h.hotel_user_id and h.hotel_user_id=g.hotel_user_id and");
		sql.append(" g.guest_id=?");
		try {
